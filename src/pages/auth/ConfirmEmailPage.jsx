...
function ConfirmEmail() {
  return (
    <div className="flex justify-center items-center px-16 py-12 text-sm leading-5 bg-white max-md:px-5">
      <div className="flex flex-col bg-slate-50 justify-center items-center p-12 mt-36 max-w-full bg-white rounded-3xl border border-solid shadow-sm border-[color:var(--Grayscale-Label-BG,#EAEBEC)] w-[479px] max-md:px-5 max-md:mt-10">
        <img
          loading="lazy"
        ...
        <Button type="submit" text="Back to Login" className="text-white text-base font-semibold font-['Inter'] leading-snug tracking-tight justify-center items-center self-stretch max-w-full px-16 py-3 mt-8 text-base font-semibold tracking-normal leading-6 text-white whitespace-nowrap bg-blue-700 rounded-md" />
      </div>
    </div>
  );
}
