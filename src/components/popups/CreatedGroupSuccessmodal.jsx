  ...
  return (
    <div className="flex flex-col justify-center p-12 text-sm text-gray-900 bg-white rounded-3xl shadow-sm max-w-[441px]">
      ...
      <div className="mt-6 leading-5 text-center">
        ...
        <GrayButton type="button" text="Done" className=" text-black text-base font-semibold font-['Inter'] leading-snug tracking-tight justify-center items-center px-4 py-3 mt-8 max-w-full  mb-12 whitespace-nowrap bg-gray-100 rounded-md leading-[143%] max-w-[344px] max-h-[44px]" />
    </div>
  );
}
